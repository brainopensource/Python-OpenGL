...
def initialize_object(vertices):
    ...
    glVertexAttribPointer(position, 3, GL_FLOAT, GL_FALSE, 24, ctypes.c_void_p(0))            # 3,0 vertices tight

    color = glGetAttribLocation(shader, "a_color")
    glEnableVertexAttribArray(color)
    glVertexAttribPointer(color, 3, GL_FLOAT, GL_FALSE, 24, ctypes.c_void_p(12))  # 3,0 vertices tight
